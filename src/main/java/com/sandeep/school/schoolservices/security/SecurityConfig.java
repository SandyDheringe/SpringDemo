package com.sandeep.school.schoolservices.security;
 ...
 * WebSecurityConfigurerAdapter { // Authentication : User --> Roles protected
 * void configure(AuthenticationManagerBuilder auth) throws Exception {
 * auth.inMemoryAuthentication().withUser("user1").password("secret1")
 * .roles("USER").and().withUser("admin1").password("secret1") .roles("USER",
 * "ADMIN"); }
 * 
